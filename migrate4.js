...
// migrate-database.js — VERSION 4 (fix sérialisation JSON + roles policy)
...
async function main() {
  ...
  for (const table of tables) {
    ...
    // pg lit automatiquement jsonb/json en objet JS, mais ne le refait PAS en sens inverse à
    // l'écriture — sans ça, un objet part comme "[object Object]", d'où l'erreur "invalid
    // input syntax for type json". On sérialise nous-mêmes ces colonnes précises avant d'insérer.
